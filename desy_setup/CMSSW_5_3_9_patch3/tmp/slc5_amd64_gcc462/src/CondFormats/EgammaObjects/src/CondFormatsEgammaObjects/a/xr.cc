// Generated at Tue Jun 17 11:29:39 2014. Do not modify it
...
#endif
#include "/nfs/dust/cms/user/pooja/scratch/h2tautau/CMSSW_5_3_9_patch3/src/CondFormats/EgammaObjects/src/classes.h"
#ifdef CONST
# undef CONST
#endif
...
namespace {
  ...
  ::Reflex::Type type_594 = ::Reflex::TypeBuilder(Reflex::Literal("float"));
  ...
  ::Reflex::Type type_514 = ::Reflex::TypeBuilder(Reflex::Literal("double"));
  ::Reflex::Type type_794 = ::Reflex::TypeBuilder(Reflex::Literal("GBRTree2D"));
  ::Reflex::Type type_1648 = ::Reflex::TypeBuilder(Reflex::Literal("GBRForest"));
  ::Reflex::Type type_542 = ::Reflex::TypeBuilder(Reflex::Literal("GBRForest2D"));
  ...
  ::Reflex::Type type_341 = ::Reflex::TypeBuilder(Reflex::Literal("ElectronLikelihoodCalibration"));
  ::Reflex::Type type_525 = ::Reflex::TypeBuilder(Reflex::Literal("ElectronLikelihoodCategoryData"));
  ::Reflex::Type type_2442 = ::Reflex::TypeBuilder(Reflex::Literal("ElectronLikelihoodCalibration::Entry"));
  ::Reflex::Type type_1777 = ::Reflex::TypeBuilder(Reflex::Literal("std::vector<ElectronLikelihoodCalibration::Entry>"));
  ::Reflex::Type type_6897 = ::Reflex::TypeBuilder(Reflex::Literal("PhysicsTools::Calibration::Histogram<float,float>"));
  ...
  ::Reflex::Type type_2519 = ::Reflex::TypeBuilder(Reflex::Literal("__gnu_cxx::__normal_iterator<GBRTree*,std::vector<GBRTree> >"));
  ::Reflex::Type type_2515 = ::Reflex::TypeBuilder(Reflex::Literal("__gnu_cxx::__normal_iterator<GBRTree2D*,std::vector<GBRTree2D> >"));
  ::Reflex::Type type_2518 = ::Reflex::TypeBuilder(Reflex::Literal("__gnu_cxx::__normal_iterator<const GBRTree*,std::vector<GBRTree> >"));
  ::Reflex::Type type_2514 = ::Reflex::TypeBuilder(Reflex::Literal("__gnu_cxx::__normal_iterator<const GBRTree2D*,std::vector<GBRTree2D> >"));
  ...
  ::Reflex::Type type_2513 = ::Reflex::TypeBuilder(Reflex::Literal("__gnu_cxx::__normal_iterator<ElectronLikelihoodCalibration::Entry*,std::vector<ElectronLikelihoodCalibration::Entry> >"));
  ::Reflex::Type type_2512 = ::Reflex::TypeBuilder(Reflex::Literal("__gnu_cxx::__normal_iterator<const ElectronLikelihoodCalibration::Entry*,std::vector<ElectronLikelihoodCalibration::Entry> >"));
  ...
  ::Reflex::Type type_3761 = ::Reflex::PointerBuilder(type_594c);
  ...
  ::Reflex::Type type_5871 = ::Reflex::ReferenceBuilder(type_341);
  ::Reflex::Type type_341c = ::Reflex::ConstBuilder(type_341);
  ::Reflex::Type type_5872 = ::Reflex::ReferenceBuilder(type_341c);
  ::Reflex::Type type_1814 = ::Reflex::TypedefTypeBuilder(Reflex::Literal("std::string"), type_1805);
  ::Reflex::Type type_6363 = ::Reflex::ReferenceBuilder(type_525);
  ::Reflex::Type type_525c = ::Reflex::ConstBuilder(type_525);
  ::Reflex::Type type_6364 = ::Reflex::ReferenceBuilder(type_525c);
  ::Reflex::Type type_6397 = ::Reflex::ReferenceBuilder(type_542);
  ::Reflex::Type type_542c = ::Reflex::ConstBuilder(type_542);
  ::Reflex::Type type_6398 = ::Reflex::ReferenceBuilder(type_542c);
  ::Reflex::Type type_4709 = ::Reflex::ReferenceBuilder(type_514);
  ::Reflex::Type type_6399 = ::Reflex::ReferenceBuilder(type_1778);
  ::Reflex::Type type_1778c = ::Reflex::ConstBuilder(type_1778);
  ::Reflex::Type type_6400 = ::Reflex::ReferenceBuilder(type_1778c);
  ::Reflex::Type type_3572 = ::Reflex::ReferenceBuilder(type_794);
  ::Reflex::Type type_794c = ::Reflex::ConstBuilder(type_794);
  ::Reflex::Type type_3467 = ::Reflex::ReferenceBuilder(type_794c);
  ::Reflex::Type type_6464 = ::Reflex::ReferenceBuilder(type_1779);
  ::Reflex::Type type_1779c = ::Reflex::ConstBuilder(type_1779);
  ::Reflex::Type type_6465 = ::Reflex::ReferenceBuilder(type_1779c);
  ...
  ::Reflex::Type type_6899 = ::Reflex::TypedefTypeBuilder(Reflex::Literal("PhysicsTools::Calibration::HistogramF"), type_6897);
  ::Reflex::Type type_3456 = ::Reflex::ReferenceBuilder(type_2442);
  ::Reflex::Type type_2442c = ::Reflex::ConstBuilder(type_2442);
  ::Reflex::Type type_3445 = ::Reflex::ReferenceBuilder(type_2442c);
  ::Reflex::Type type_3454 = ::Reflex::PointerBuilder(type_2442);
  ::Reflex::Type type_3443 = ::Reflex::PointerBuilder(type_2442c);
  ...
  ::Reflex::Type type_3569 = ::Reflex::PointerBuilder(type_794);
  ::Reflex::Type type_3465 = ::Reflex::PointerBuilder(type_794c);
...
void __GBRTree_db_funcmem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_514, type_3761), Reflex::Literal("GetResponse"), method_2221, 0, "vector", ::Reflex::PUBLIC | ::Reflex::CONST)
...
static void destructor_2443(void*, void * o, const std::vector<void*>&, void *) {
(((::ElectronLikelihoodCalibration*)o)->::ElectronLikelihoodCalibration::~ElectronLikelihoodCalibration)();
}
static  void operator_2444( void* retaddr, void* o, const std::vector<void*>& arg, void*)
{
...
static void constructor_2445( void* retaddr, void* mem, const std::vector<void*>& arg, void*) {
...
static void constructor_2446( void* retaddr, void* mem, const std::vector<void*>&, void*) {
...
void __ElectronLikelihoodCalibration_dict() {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("~ElectronLikelihoodCalibration"), destructor_2443, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::DESTRUCTOR )
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5871, type_5872), Reflex::Literal("operator="), operator_2444, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::OPERATOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_5872), Reflex::Literal("ElectronLikelihoodCalibration"), constructor_2445, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("ElectronLikelihoodCalibration"), constructor_2446, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
...
static void destructor_2591(void*, void * o, const std::vector<void*>&, void *) {
(((::ElectronLikelihoodCategoryData*)o)->::ElectronLikelihoodCategoryData::~ElectronLikelihoodCategoryData)();
}
static  void operator_2592( void* retaddr, void* o, const std::vector<void*>& arg, void*)
{
...
static void constructor_2593( void* retaddr, void* mem, const std::vector<void*>& arg, void*) {
...
static void constructor_2594( void* retaddr, void* mem, const std::vector<void*>&, void*) {
  if (retaddr) *(void**)retaddr = ::new(mem) ::ElectronLikelihoodCategoryData();
  else ::new(mem) ::ElectronLikelihoodCategoryData();
}

static void method_newdel_525( void* retaddr, void*, const std::vector<void*>&, void*)
{
  static ::Reflex::NewDelFunctions s_funcs;
...
void __ElectronLikelihoodCategoryData_dict() {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("~ElectronLikelihoodCategoryData"), destructor_2591, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::DESTRUCTOR )
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_6363, type_6364), Reflex::Literal("operator="), operator_2592, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::OPERATOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_6364), Reflex::Literal("ElectronLikelihoodCategoryData"), constructor_2593, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("ElectronLikelihoodCategoryData"), constructor_2594, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember<void*(void)>(Reflex::Literal("__getNewDelFunctions"), method_newdel_525, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL)
...
static  void operator_2619( void* retaddr, void* o, const std::vector<void*>& arg, void*)
{
...
static void constructor_2620( void* retaddr, void* mem, const std::vector<void*>& arg, void*) {
  if (retaddr) *(void**)retaddr = ::new(mem) ::GBRForest2D(*(const ::GBRForest2D*)arg[0]);
  else ::new(mem) ::GBRForest2D(*(const ::GBRForest2D*)arg[0]);
}

static void constructor_2621( void* retaddr, void* mem, const std::vector<void*>&, void*) {
  if (retaddr) *(void**)retaddr = ::new(mem) ::GBRForest2D();
  else ::new(mem) ::GBRForest2D();
}

static void destructor_2622(void*, void * o, const std::vector<void*>&, void *) {
...
static void method_newdel_542( void* retaddr, void*, const std::vector<void*>&, void*)
{
  static ::Reflex::NewDelFunctions s_funcs;
...
void __GBRForest2D_dict() {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_6397, type_6398), Reflex::Literal("operator="), operator_2619, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::OPERATOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_6398), Reflex::Literal("GBRForest2D"), constructor_2620, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("GBRForest2D"), constructor_2621, 0, 0, ::Reflex::PUBLIC | ::Reflex::EXPLICIT | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("~GBRForest2D"), destructor_2622, 0, 0, ::Reflex::PUBLIC | ::Reflex::DESTRUCTOR )
  .AddFunctionMember<void*(void)>(Reflex::Literal("__getNewDelFunctions"), method_newdel_542, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL)
...
void __GBRForest2D_db_datamem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddDataMember(type_514, Reflex::Literal("fInitialResponseX"), OffsetOf(__shadow__::__GBRForest2D, fInitialResponseX), ::Reflex::PROTECTED)
  .AddDataMember(type_514, Reflex::Literal("fInitialResponseY"), OffsetOf(__shadow__::__GBRForest2D, fInitialResponseY), ::Reflex::PROTECTED)
...
void __GBRForest2D_db_funcmem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_3761, type_4709, type_4709), Reflex::Literal("GetResponse"), method_2623, 0, "vector;x;y", ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_514, type_514), Reflex::Literal("SetInitialResponse"), method_2624, 0, "x;y", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_6399), Reflex::Literal("Trees"), method_2625, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_6400), Reflex::Literal("Trees"), method_2626, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST);
}
//------Stub functions for class GBRTree2D -------------------------------
static  void operator_2751( void* retaddr, void* o, const std::vector<void*>& arg, void*)
{
  if (retaddr) *(void**)retaddr = (void*)&(((::GBRTree2D*)o)->operator=)(*(const ::GBRTree2D*)arg[0]);
  else   (((::GBRTree2D*)o)->operator=)(*(const ::GBRTree2D*)arg[0]);
}

static void constructor_2752( void* retaddr, void* mem, const std::vector<void*>& arg, void*) {
  if (retaddr) *(void**)retaddr = ::new(mem) ::GBRTree2D(*(const ::GBRTree2D*)arg[0]);
  else ::new(mem) ::GBRTree2D(*(const ::GBRTree2D*)arg[0]);
}

static void constructor_2753( void* retaddr, void* mem, const std::vector<void*>&, void*) {
...
static  void method_2755( void*, void* o, const std::vector<void*>& arg, void*)
{
...
static  void method_2757( void* retaddr, void* o, const std::vector<void*>&, void*)
{
...
static void method_newdel_794( void* retaddr, void*, const std::vector<void*>&, void*)
{
  static ::Reflex::NewDelFunctions s_funcs;
...
void __GBRTree2D_dict() {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_3572, type_3467), Reflex::Literal("operator="), operator_2751, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::OPERATOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_3467), Reflex::Literal("GBRTree2D"), constructor_2752, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("GBRTree2D"), constructor_2753, 0, 0, ::Reflex::PUBLIC | ::Reflex::EXPLICIT | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("~GBRTree2D"), destructor_2754, 0, 0, ::Reflex::PUBLIC | ::Reflex::DESTRUCTOR )
  .AddFunctionMember<void*(void)>(Reflex::Literal("__getNewDelFunctions"), method_newdel_794, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL)
...
void __GBRTree2D_db_funcmem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_3761, type_4709, type_4709), Reflex::Literal("GetResponse"), method_2755, 0, "vector;x;y", ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_38, type_3761), Reflex::Literal("TerminalIndex"), method_2756, 0, "vector", ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5724), Reflex::Literal("ResponsesX"), method_2757, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5725), Reflex::Literal("ResponsesX"), method_2758, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5724), Reflex::Literal("ResponsesY"), method_2759, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5725), Reflex::Literal("ResponsesY"), method_2760, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_6464), Reflex::Literal("CutIndices"), method_2761, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_6465), Reflex::Literal("CutIndices"), method_2762, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5724), Reflex::Literal("CutVals"), method_2763, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5725), Reflex::Literal("CutVals"), method_2764, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5728), Reflex::Literal("LeftIndices"), method_2765, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5729), Reflex::Literal("LeftIndices"), method_2766, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5728), Reflex::Literal("RightIndices"), method_2767, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_5729), Reflex::Literal("RightIndices"), method_2768, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST);
}
...
void __GBRForest_db_datamem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddDataMember(type_514, Reflex::Literal("fInitialResponse"), OffsetOf(__shadow__::__GBRForest, fInitialResponse), ::Reflex::PROTECTED)
...
void __GBRForest_db_funcmem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_514, type_3761), Reflex::Literal("GetResponse"), method_3014, 0, "vector", ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_514, type_3761), Reflex::Literal("GetClassifier"), method_3015, 0, "vector", ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_514), Reflex::Literal("SetInitialResponse"), method_3016, 0, "response", ::Reflex::PUBLIC)
...
static  void operator_5868( void* retaddr, void* o, const std::vector<void*>& arg, void*)
{
...
static void constructor_5869( void* retaddr, void* mem, const std::vector<void*>& arg, void*) {
...
static void constructor_5870( void* retaddr, void* mem, const std::vector<void*>&, void*) {
  if (retaddr) *(void**)retaddr = ::new(mem) ::ElectronLikelihoodCalibration::Entry();
  else ::new(mem) ::ElectronLikelihoodCalibration::Entry();
}

static void method_newdel_2442( void* retaddr, void*, const std::vector<void*>&, void*)
{
  static ::Reflex::NewDelFunctions s_funcs;
...
void __ElectronLikelihoodCalibration__Entry_dict() {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("~Entry"), destructor_5867, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::DESTRUCTOR )
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_3456, type_3445), Reflex::Literal("operator="), operator_5868, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::OPERATOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_3445), Reflex::Literal("Entry"), constructor_5869, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("Entry"), constructor_5870, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember<void*(void)>(Reflex::Literal("__getNewDelFunctions"), method_newdel_2442, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL)
...
void __ElectronLikelihoodCalibration__Entry_db_datamem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddDataMember(type_525, Reflex::Literal("category"), OffsetOf(__shadow__::__ElectronLikelihoodCalibration__Entry, category), ::Reflex::PUBLIC)
  .AddDataMember(type_6899, Reflex::Literal("histogram"), OffsetOf(__shadow__::__ElectronLikelihoodCalibration__Entry, histogram), ::Reflex::PUBLIC);
}
...
void __std__vector_ElectronLikelihoodCalibration__Entry__dict() {
  ...
  .AddTypedef(type_2442, Reflex::Literal("std::vector<ElectronLikelihoodCalibration::Entry>::_Alloc_value_type"))
  ...
  .AddTypedef(type_2442, Reflex::Literal("std::vector<ElectronLikelihoodCalibration::Entry>::value_type"))
  ...
  .AddTypedef(type_2513, Reflex::Literal("std::vector<ElectronLikelihoodCalibration::Entry>::iterator"))
  .AddTypedef(type_2512, Reflex::Literal("std::vector<ElectronLikelihoodCalibration::Entry>::const_iterator"))
...
void __std__vector_ElectronLikelihoodCalibration__Entry__db_funcmem(Reflex::Class* cl) {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2513), Reflex::Literal("begin"), method_3526, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2512), Reflex::Literal("begin"), method_3527, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2513), Reflex::Literal("end"), method_3528, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2512), Reflex::Literal("end"), method_3529, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_1981, type_2442), Reflex::Literal("resize"), method_3536, 0, "__new_size;__x=_Tp()", ::Reflex::PUBLIC)
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2513, type_2513, type_3445), Reflex::Literal("insert"), method_3553, 0, "__position;__x", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_2513, type_1981, type_3445), Reflex::Literal("insert"), method_3554, 0, "__position;__n;__x", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2513, type_2513), Reflex::Literal("erase"), method_3555, 0, "__position", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2513, type_2513, type_2513), Reflex::Literal("erase"), method_3556, 0, "__first;__last", ::Reflex::PUBLIC)
...
void __std__vector_GBRTree2D__dict() {
  ...
  .AddTypedef(type_794, Reflex::Literal("std::vector<GBRTree2D>::_Alloc_value_type"))
  ...
  .AddTypedef(type_794, Reflex::Literal("std::vector<GBRTree2D>::value_type"))
  ...
  .AddTypedef(type_2515, Reflex::Literal("std::vector<GBRTree2D>::iterator"))
  .AddTypedef(type_2514, Reflex::Literal("std::vector<GBRTree2D>::const_iterator"))
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_6400), Reflex::Literal("vector"), constructor_3585, 0, "__x", ::Reflex::PUBLIC | ::Reflex::CONSTRUCTOR)
...
void __std__vector_GBRTree2D__db_funcmem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_6399, type_6400), Reflex::Literal("operator="), operator_3587, 0, "__x", ::Reflex::PUBLIC | ::Reflex::OPERATOR)
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2515), Reflex::Literal("begin"), method_3589, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2514), Reflex::Literal("begin"), method_3590, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2515), Reflex::Literal("end"), method_3591, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2514), Reflex::Literal("end"), method_3592, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_1981, type_794), Reflex::Literal("resize"), method_3599, 0, "__new_size;__x=_Tp()", ::Reflex::PUBLIC)
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2515, type_2515, type_3467), Reflex::Literal("insert"), method_3616, 0, "__position;__x", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_2515, type_1981, type_3467), Reflex::Literal("insert"), method_3617, 0, "__position;__n;__x", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2515, type_2515), Reflex::Literal("erase"), method_3618, 0, "__position", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2515, type_2515, type_2515), Reflex::Literal("erase"), method_3619, 0, "__first;__last", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_6399), Reflex::Literal("swap"), method_3620, 0, "__x", ::Reflex::PUBLIC)
...
void __std__vector_GBRTree__dict() {
  ...
  .AddTypedef(type_2519, Reflex::Literal("std::vector<GBRTree>::iterator"))
  .AddTypedef(type_2518, Reflex::Literal("std::vector<GBRTree>::const_iterator"))
...
void __std__vector_GBRTree__db_funcmem(Reflex::Class* cl) {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2519), Reflex::Literal("begin"), method_3844, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2518), Reflex::Literal("begin"), method_3845, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2519), Reflex::Literal("end"), method_3846, 0, 0, ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2518), Reflex::Literal("end"), method_3847, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2519, type_2519, type_3478), Reflex::Literal("insert"), method_3871, 0, "__position;__x", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_96, type_2519, type_1981, type_3478), Reflex::Literal("insert"), method_3872, 0, "__position;__n;__x", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2519, type_2519), Reflex::Literal("erase"), method_3873, 0, "__position", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2519, type_2519, type_2519), Reflex::Literal("erase"), method_3874, 0, "__first;__last", ::Reflex::PUBLIC)
...
namespace {
  struct Dictionaries {
    ...
    ~Dictionaries() {
      ...
      type_341.Unload(); // class ElectronLikelihoodCalibration 
      type_525.Unload(); // class ElectronLikelihoodCategoryData 
      type_542.Unload(); // class GBRForest2D 
      type_794.Unload(); // class GBRTree2D 
      type_1648.Unload(); // class GBRForest 
      type_2442.Unload(); // class ElectronLikelihoodCalibration::Entry 
